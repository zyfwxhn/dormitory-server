        ...
        <el-table-column label="操作" width="160" align="center" fixed="right">
          <template #default="scope">
            ...
            <el-button
              ...
              type="success"
              link
              @click="handleSolved(scope.row.id)"
            >标记解决</el-button>
            <el-button
              v-if="scope.row.status === 0"
              type="danger"
...
import { getLostFoundPage, publishLostFound, updateLostFoundStatus } from '@/api/lostfound'

const loading = ref(false)
const tableData = ref([])
const total = ref(0)
const queryParams = reactive({ page: 1, pageSize: 10, type: null, category: null, title: null })
